...
|B2| [Final Product (Chapter 2)](https://www.facebook.com/codingcompetitions/hacker-cup/2025/round-1/problems/B2)| [Python3](./Practice%20Round/final_product_chapter_2.py3) | _O(sqrt(B) + (logB)^2 * log(logB))_ | _O(logB)_ | Easy | | Number Theory, Combinatorics, Stars and Bars |
