...
|C| [Adversarial Attack](https://www.facebook.com/codingcompetitions/hacker-cup/2025/round-3/problems/C)| [PyPy3](./Round%203/adversarial_attack.py3) | _O(N * (L + (logL)^2 * K / 64))_ | _O(L + K / 64)_ | Hard | | KMP, Bitset DP, Binary Lifting |
...
|B| [Polishing Problems](https://www.facebook.com/codingcompetitions/hacker-cup/2025/final-round/problems/B)| [Python3](./Final%20Round/polishing_problems.py3) | _O(L + T * (C + K * F * N / 64) + TlogT)_ | _O(L)_ | Hard | | Math, Freq Table, Sliding Window, Bag of Words, Quick Select, LCS, Bitset DP |
|C1| [Cube Coloring (Chapter 1)](https://www.facebook.com/codingcompetitions/hacker-cup/2025/final-round/problems/C1)| [Python3](./Final%20Round/cube_coloring_chapter_1.py3) | _O(N^3)_ | _O(N^2)_ | Medium | | Constructive Algorithms |
...
|F| [Reindeer Rally](https://www.facebook.com/codingcompetitions/hacker-cup/2025/final-round/problems/F)| [Python3](./Final%20Round/reindeer_rally.py3) | _O(M^2 * RlogR / 64 + N * MlogM)_ | _O(N * M + R * M^2 / 64)_ | Hard | | Binary Splitting, Bitset DP, Backtracing, EGZ Theorem |
